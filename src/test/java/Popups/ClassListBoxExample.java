...
public class ClassListBoxExample {
	...
	@Test
	public void classListBox_Test() {
		driver.get("file:/Users/praveenanbu/eclipse-workspace/SeleniumAutomationCQA_107/Driver/ListBox_Brewakfast.html");
	...
	@Test
	public void printListValues_SortedOrder_Test() {
		driver.get("file:/Users/praveenanbu/eclipse-workspace/SeleniumAutomationCQA_107/Driver/ListBox_Brewakfast.html");
	...
	@Test
	public void printUniqueElementinthelistbox_test() {
		driver.get("file:/Users/praveenanbu/eclipse-workspace/SeleniumAutomationCQA_107/Driver/ListBox_Brewakfast.html");
		WebElement listElement = driver.findElement(By.id("mtr"));
		Select s = new Select(listElement);
		List<WebElement> allOptions = s.getOptions();
    ...
    @Test
    public void printUniqueElement_Sorted_test() {
    	driver.get("file:/Users/praveenanbu/eclipse-workspace/SeleniumAutomationCQA_107/Driver/ListBox_Brewakfast.html");
    	WebElement listElement = driver.findElement(By.id("mtr"));
    	Select s = new Select(listElement);
    	List<WebElement> allOptions = s.getOptions();
    ...
    @Test
    public void checklisthasDUPLICATEvalues_HashSet_test() {
    	driver.get("file:/Users/praveenanbu/eclipse-workspace/SeleniumAutomationCQA_107/Driver/ListBox_Brewakfast.html");
    ...
    @Test
    public void PrinttheDUPLICATEItem_intheList_HashSet_test() {
    	driver.get("file:/Users/praveenanbu/eclipse-workspace/SeleniumAutomationCQA_107/Driver/ListBox_Brewakfast.html");
    			WebElement listbox = driver.findElement(By.id("mtr"));
    			Select s = new Select(listbox);
    			List<WebElement> allOptions = s.getOptions();
    ...
    @Test
    public void HashMapExample_printtheOcuuranceOfPoori_test() {
    	driver.get("file:/Users/praveenanbu/eclipse-workspace/SeleniumAutomationCQA_107/Driver/ListBox_Brewakfast.html");
