...
public class Xpath_Login_Sgnup {
	
	@Test
	public void fb_Xpath_login() throws InterruptedException {
        ...
        Thread.sleep(2000);
        driver.findElement(By.xpath("//input[@id='pass']")).sendKeys("praveen2221");
        Thread.sleep(2000);
...
//        Thread.sleep(2000);
	...
	@Test
	public void fb_Xpath_Signup() throws InterruptedException {
		System.setProperty("webdriver.chrome.driver","/Users/praveenanbu/eclipse-workspace/SeleniumAutomationCQA_107/Driver/chromedriver");
		WebDriver driver = new ChromeDriver();
		driver.manage().window().maximize();
		Thread.sleep(2000);
        ...
        driver.findElement(By.xpath("//input[@name=\'reg_email__\']")).sendKeys("praveenap3331@gmail.com");
        Thread.sleep(3000);
        driver.findElement(By.xpath("//input[@name=\'reg_email_confirmation__\']")).sendKeys("praveenap3331@gmail.com");
        Thread.sleep(3000);
        driver.findElement(By.xpath("//input[@id=\'password_step_input\']")).sendKeys("praveen2221");
        Thread.sleep(3000);
